...
public class DistanceMonitor {
	...
	Image image = new ImageIcon("test_images/test2.jpg").getImage();
	int width = 50;
	int height = 50;

    //The three thresholds that decide how cluster are found.
    final static int redThreshold = 60;        //The minimum red value for a pixel to be considerd.
    ...
    int getRed(int x, int y, int[] pixels){
	...
	public static void main(String[] args) {
		DistanceMonitor prog = new DistanceMonitor();
		prog.run();
	}
